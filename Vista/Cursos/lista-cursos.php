                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="dataTable_wrapper">
                                <a class="btn btn-warning btn-sm" href="../Vista/Accion.php?c=alumnoCurso&a=ListaCursosDeAlumno&alumno=<?php echo $pvd->persona_id; ?>" role="button">Ver cursos</a>
                                ...
                                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <?php 
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <?php }else{ ?>
                                                <td style="text-align: center"><a class="btn btn-danger btn-sm" href="?c=alumnoCurso&a=DesmatricularCurso&aa=<?php echo $row['alumno_curso_id'] ?>&b=<?php echo $pvd->persona_id; ?>" role="button">Desmatricular</a></td>                                           
                                            <?php } ?>
                                        </tr>                                        
                                    <?php endforeach; ?>
                                    </tbody>
